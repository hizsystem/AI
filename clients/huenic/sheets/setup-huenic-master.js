...
function updateSummary(ss) {
  ...
  sheet.getRange(15, 1, 1, 3).setFontWeight("bold").setBackground("#f3f4f6");
  sheet.getRange(22, 1, 1, 3).setFontWeight("bold").setBackground("#e5e7eb");

  // 금액 포맷
  sheet.getRange(6, 2).setNumberFormat("#,##0");
  sheet.getRange(9, 2, 4, 1).setNumberFormat("#,##0");
  sheet.getRange(16, 2, 7, 1).setNumberFormat("#,##0");
